 ...
 */
export function CollapsibleNumberPickerPresenter({
  viewModel,
}: CollapsibleNumberPickerPresenterProps) {
  const {
    labelProps,
    ariaProps,
    refs,
  ...
  return (
    <div className="quick-number-input-root space-y-2" style={cssVariables}>
      ...
      <div className="relative min-h-[3rem] md:min-h-[3.5rem]" ref={wrapperRef}>
        <div data-testid="qni-closed" aria-hidden={showPicker} style={closedDisplayStyle}>
          <div
