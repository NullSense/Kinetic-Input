...
export function useResolvedVisualTweaks(
  ...
  return useMemo(() => {
    ...
    return {
      ...
      colorTransitionMs:
        overrides.colorTransitionMs ??
        transitionMs ??
        DEFAULT_TWEAKS.colorTransitionMs,
      scaleTransitionMs:
        overrides.scaleTransitionMs ??
        transitionMs ??
        DEFAULT_TWEAKS.scaleTransitionMs,
      ...
      deselectOpacity:
        overrides.deselectOpacity ?? DEFAULT_TWEAKS.deselectOpacity,
      trailOvershoot: overrides.trailOvershoot ?? DEFAULT_TWEAKS.trailOvershoot,
      highlightPadding:
        overrides.highlightPadding ?? DEFAULT_TWEAKS.highlightPadding,
    };
  }, [overrides]);
}
